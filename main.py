...
def main(args):
    ...
    if(args.method == 'rename_method'):
        ...
        my_listener = RenameFieldRefactoringListener(common_token_stream=token_stream, class_identifier="Piece", field_identifier="y", new_field_identifier="y_Motherfucker")
